    ...
    >
      ...
      <div className="max-w-7xl mx-auto sm:w-screen flex flex-col md:flex-row items-center space-between relative z-10 lg:mt-40 sm:mt-10">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="md:w-1/2 text-center md:text-left lg:ml-20"
        >
          <div className="max-w-2xl mx-auto order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]">
